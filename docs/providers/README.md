...
|---|---|---|
| Phase 0: local demo | Show end-to-end flow without accounts | Use current FastAPI endpoints and mocked responses |
| Phase 1: hackathon demo | Real WhatsApp/SMS/voice proof | Authkey sandbox/trial for SMS or WhatsApp, Meta WhatsApp Cloud API test number, Vomyra trial for voice if signup is fast |
...
3. Voice call through Vomyra or IVR provider: only for high/critical priority alerts.
