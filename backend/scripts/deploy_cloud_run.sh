...
GCP_REGION=${REGION},\
VERTEX_AI_LOCATION=${VERTEX_AI_LOCATION:-${GOOGLE_CLOUD_LOCATION:-global}},\
SPEECH_LOCATION=${SPEECH_LOCATION:-global},\
TRANSLATION_LOCATION=${TRANSLATION_LOCATION:-global},\
...
GEMINI_FALLBACK_MODELS=${GEMINI_FALLBACK_MODELS:-${GEMINI_MODEL}},\
VERTEX_AI_FALLBACK_MODELS=${VERTEX_AI_FALLBACK_MODELS:-${VERTEX_AI_MODEL}},\
