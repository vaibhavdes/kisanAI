...
class RecommendationEngine:
    def recommend(
        ...
        satellite_evi: float | None = None,
        satellite_ndre: float | None = None,
        satellite_water_stress: str | None = None,
        satellite_vegetation_status: str | None = None,
        satellite_moisture_status: str | None = None,
        satellite_chlorophyll_status: str | None = None,
        ...
        return CropRecommendationResponse(
            ...
            data_sources={
                ...
                "moistureStatus": satellite_moisture_status,
                "chlorophyllStatus": satellite_chlorophyll_status,
